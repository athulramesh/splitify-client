...
function EditExpense({ expenseId, groupId, groupMemberList, expenseCallback }) {
  ...
  const handleExpense = () => {
    ...
    //TODO to be implemented after backend validation
    ExpenseAdapter.updateExpense(currentUser, expenseId, req).then(() => {
      expenseCallback(req);
    });
    handleClose();
  };
